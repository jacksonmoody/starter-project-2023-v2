export function TypographyH1({ children }: { children: string }) {
  return <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight lg:text-5xl">{children}</h1>;
}
...
export function TypographyH3({ children }: { children: string }) {
  return <h3 className="scroll-m-20 text-center text-2xl font-semibold tracking-tight">{children}</h3>;
}

export function TypographyH4({ children }: { children: string }) {
  return <h4 className="scroll-m-20 text-center text-xl font-semibold tracking-tight">{children}</h4>;
}
