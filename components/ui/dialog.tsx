...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-0 z-50 grid w-full -translate-x-1/2 gap-4 rounded-b-lg bg-white p-6 sm:top-1/2 sm:max-w-lg sm:-translate-y-1/2 sm:rounded-lg",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-3/4 data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-3/4 data-[state=closed]:sm:zoom-out-90 data-[state=open]:sm:zoom-in-90 data-[state=closed]:sm:slide-out-to-top-1/2 data-[state=open]:sm:slide-in-from-top-1/2",
        "dark:bg-slate-900",
        className,
      )}
      {...props}
